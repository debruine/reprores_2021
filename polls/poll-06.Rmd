...
# [Poll](https://forms.gle/w6xkWrmoRsp5dtsb7)
...
data <- read_sheet(url, sheet = "Week6") %>%
  filter(row_number() != 1)
...
### How did you engage with Chapter 6?
...
### List concepts you learned in Chapter 6 that you feel confident about.
...
### List concepts you learned in Chapter 6 that you feel less confident about and would like reviewed in class today.
