Reproducible Report for 2615739
=========================================

Your questionnaire measures stress. Your research question is to determine if the stress score differs by condition for the subset of the sample where version is hard. In other words, if you only analyse the participants for whom version is hard, what is the main effect of condition on their stress score?
