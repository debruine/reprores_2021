Reproducible Report for 2119330
=========================================

Your questionnaire measures extroversion. Your research question is to determine if the extroversion score differs by condition for the subset of the sample where version is 2. In other words, if you only analyse the participants for whom version is 2, what is the main effect of condition on their extroversion score?
...
4. Do a power analysis to determine the sample size you would need to have 90% power to detect a 0.5-point difference between the levels of condition with an alpha criterion of 0.05.
