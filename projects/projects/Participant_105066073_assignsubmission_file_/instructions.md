Reproducible Report for 2715877
=========================================

Your questionnaire measures stress. Your research question is to determine if the stress score differs by language for the subset of the sample where version is 2. In other words, if you only analyse the participants for whom version is 2, what is the main effect of language on their stress score?
