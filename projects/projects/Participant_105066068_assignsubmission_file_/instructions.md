Reproducible Report for 2542696
=========================================

Your questionnaire measures extroversion. Your research question is to determine if the extroversion score differs by version for the subset of the sample where condition is ctrl. In other words, if you only analyse the participants for whom condition is ctrl, what is the main effect of version on their extroversion score?
