Reproducible Report for 2331250
=========================================

Your questionnaire measures extroversion. Your research question is to determine if the extroversion score differs by language for the subset of the sample where version is 2. In other words, if you only analyse the participants for whom version is 2, what is the main effect of language on their extroversion score?
