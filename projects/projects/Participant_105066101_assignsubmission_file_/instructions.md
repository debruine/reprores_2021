Reproducible Report for 2327525
=========================================

Your questionnaire measures stress. Your research question is to determine if the stress score differs by version for the subset of the sample where condition is cond2. In other words, if you only analyse the participants for whom condition is cond2, what is the main effect of version on their stress score?
