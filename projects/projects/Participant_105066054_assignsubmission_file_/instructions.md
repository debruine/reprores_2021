Reproducible Report for 2716556
=========================================

Your questionnaire measures extroversion. Your research question is to determine if the extroversion score differs by language for the subset of the sample where version is 1. In other words, if you only analyse the participants for whom version is 1, what is the main effect of language on their extroversion score?
...
4. Do a power analysis to determine the sample size you would need to have 85% power to detect a 0.5-point difference between the levels of language with an alpha criterion of 0.05.
