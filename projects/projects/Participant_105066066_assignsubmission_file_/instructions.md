Reproducible Report for 2650052
=========================================

Your questionnaire measures stress. Your research question is to determine if the stress score differs by language for the subset of the sample where condition is ctrl. In other words, if you only analyse the participants for whom condition is ctrl, what is the main effect of language on their stress score?
...
The 12 stress questionnaire items are on a scale from 1 (low) to 7 (high), but some of the items need to be reverse-coded. This is indicated by the letter R in the question column name. You create the stress score by summing the questions *after* reversing the relevant questions.
