...
ggplot(subdat, aes(x = x, fill = x)) +
  ...
  scale_x_discrete(name = "",  drop=FALSE) +
  scale_y_continuous(name = "", breaks = 0:11*5) +
  scale_fill_manual(values = tolower(rainbow)) +
  coord_flip(ylim = c(0, n)) 
```
...
### List concepts you learned in Chapter 3 that you feel less confident about and would like reviewed in class today.
