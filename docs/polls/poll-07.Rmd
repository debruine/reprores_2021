...
data <- read_sheet(url, sheet = "Week7") %>%
  filter(row_number() != 0)
...
### How did you engage with Chapter 7?
...
### List concepts you learned in Chapter 7 that you feel confident about.
...
### List concepts you learned in Chapter 7 that you feel less confident about and would like reviewed in class today.
