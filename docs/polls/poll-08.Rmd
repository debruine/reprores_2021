...
data <- read_sheet(url, sheet = "Week8") %>%
  filter(row_number() != 0)
...
### How did you engage with Chapter 8?
...
### List concepts you learned in Chapter 8 that you feel confident about.
...
### List concepts you learned in Chapter 8 that you feel less confident about and would like reviewed in class today.
